...
for i in range(game_count):
    game_wrapper = GameWrapper(70, 70, [HeuristicPlayer(1, [1, 1, 1]), HeuristicPlayer(2, [1, 1, 1]), HeuristicPlayer(3, [1, 1, 1]), HeuristicPlayer(4, [1, 1, 1]), SimplePlayer(), PathFindingPlayer(9)])

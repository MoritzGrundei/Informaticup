...
for i in range(game_count):
    game_wrapper = GameWrapper(70, 70, [HeuristicPlayer(1, [1, 1, 1],41), HeuristicPlayer(2, [1, 1, 1], 49), HeuristicPlayer(3, [1, 1, 1], 51), HeuristicPlayer(4, [1, 1, 1], 59), SimplePlayer(49), PathFindingPlayer(9, 41)])
